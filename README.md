...
you'll need the CoreML models. grab them from [HuggingFace](https://huggingface.co/Jud/kokoro-coreml) or convert them yourself.
...
the package includes a small CLI for quick testing:

```bash
swift run kokoro-say "hello from the terminal" --voice af_heart --model-dir ~/models/kokoro
```
